Shader "Shader Graphs/Ahtsham_Lit_Dashboard"
{
    Properties
    {
        [NoScaleOffset]_Base("Base", 2D) = "white" {}
        [NoScaleOffset]_Light("Light", 2D) = "white" {}
        _Blend_Factor("Blend Factor", Range(0, 1)) = 0
        [NoScaleOffset]_Engine_Emi("Engine (Emi)", 2D) = "white" {}
        [ToggleUI]_EL("EL", Float) = 0
        ...
        [NoScaleOffset]_Parking_Emi("Parking (Emi)", 2D) = "white" {}
        [ToggleUI]_PL("PL", Float) = 0
        [NoScaleOffset]_Retarder_Emi("Retarder(Emi)", 2D) = "white" {}
        [ToggleUI]_RT("RT", Float) = 0
    ...
    SubShader
    {
        ...
        float _PL;
        float4 _Parking_Emi_TexelSize;
        float4 _Retarder_Emi_TexelSize;
        ...
        TEXTURE2D(_Engine_Emi);
        SAMPLER(sampler_Engine_Emi);
        ...
        TEXTURE2D(_Parking_Emi);
        SAMPLER(sampler_Parking_Emi);
        TEXTURE2D(_Retarder_Emi);
        SAMPLER(sampler_Retarder_Emi);
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            UnityTexture2D _Property_ea5d3446ea6b416aa763744813415f54_Out_0_Texture2D = UnityBuildTexture2DStructNoScale(_Light);
            ...
            float _Property_911fb0d73dfb4b0ca09c3bb41edc896c_Out_0_Float = _Blend_Factor;
            float4 _Lerp_41d1a039672e49f09c119c925bf4e5f7_Out_3_Vector4;
            Unity_Lerp_float4(_SampleTexture2D_d9a02454f9b64150bd2dda27792ae737_RGBA_0_Vector4, _SampleTexture2D_cd62480f4ed4495e8a325ad1766b2c5d_RGBA_0_Vector4, (_Property_911fb0d73dfb4b0ca09c3bb41edc896c_Out_0_Float.xxxx), _Lerp_41d1a039672e49f09c119c925bf4e5f7_Out_3_Vector4);
            UnityTexture2D _Property_9e18aed5617c40d38e5d61a182a32af3_Out_0_Texture2D = UnityBuildTexture2DStructNoScale(_Engine_Emi);
            ...
            float _Property_5d49a99a6f5841a1bc724ef2185ee269_Out_0_Boolean = _EL;
            ...
            UnityTexture2D _Property_c663960e066446399630485727185cdb_Out_0_Texture2D = UnityBuildTexture2DStructNoScale(_Parking_Emi);
            ...
            float _Property_3f79a615983f4b57abac960145641ee5_Out_0_Boolean = _PL;
            ...
            UnityTexture2D _Property_4763fff875d7492c97df18256738bc04_Out_0_Texture2D = UnityBuildTexture2DStructNoScale(_Retarder_Emi);
            float4 _SampleTexture2D_9349eb805b164476a2e137c27b3f7aec_RGBA_0_Vector4 = SAMPLE_TEXTURE2D(_Property_4763fff875d7492c97df18256738bc04_Out_0_Texture2D.tex, _Property_4763fff875d7492c97df18256738bc04_Out_0_Texture2D.samplerstate, _Property_4763fff875d7492c97df18256738bc04_Out_0_Texture2D.GetTransformedUV(IN.uv0.xy) );
            float _SampleTexture2D_9349eb805b164476a2e137c27b3f7aec_R_4_Float = _SampleTexture2D_9349eb805b164476a2e137c27b3f7aec_RGBA_0_Vector4.r;
            float _SampleTexture2D_9349eb805b164476a2e137c27b3f7aec_G_5_Float = _SampleTexture2D_9349eb805b164476a2e137c27b3f7aec_RGBA_0_Vector4.g;
            float _SampleTexture2D_9349eb805b164476a2e137c27b3f7aec_B_6_Float = _SampleTexture2D_9349eb805b164476a2e137c27b3f7aec_RGBA_0_Vector4.b;
            float _SampleTexture2D_9349eb805b164476a2e137c27b3f7aec_A_7_Float = _SampleTexture2D_9349eb805b164476a2e137c27b3f7aec_RGBA_0_Vector4.a;
            float _Property_b86a71d9aa594bc3ae77e00bc03c7a9a_Out_0_Boolean = _RT;
            float4 _Multiply_b1922586fed7427fbd458fc3ff17642d_Out_2_Vector4;
            Unity_Multiply_float4_float4(_SampleTexture2D_9349eb805b164476a2e137c27b3f7aec_RGBA_0_Vector4, (((float) _Property_b86a71d9aa594bc3ae77e00bc03c7a9a_Out_0_Boolean).xxxx), _Multiply_b1922586fed7427fbd458fc3ff17642d_Out_2_Vector4);
            float4 _Add_d9dc58868c3042218cbc31dbfe09027f_Out_2_Vector4;
            Unity_Add_float4(_Multiply_b1922586fed7427fbd458fc3ff17642d_Out_2_Vector4, float4(0, 0, 0, 0), _Add_d9dc58868c3042218cbc31dbfe09027f_Out_2_Vector4);
            float4 _Add_a47c008b6c174c32a2fe25117c67b858_Out_2_Vector4;
            Unity_Add_float4(_Add_5da25797012a4573b9295f462a9e99e0_Out_2_Vector4, _Add_d9dc58868c3042218cbc31dbfe09027f_Out_2_Vector4, _Add_a47c008b6c174c32a2fe25117c67b858_Out_2_Vector4);
            ...
            surface.BaseColor = (_Lerp_41d1a039672e49f09c119c925bf4e5f7_Out_3_Vector4.xyz);
