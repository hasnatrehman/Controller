Shader "Ciconia Studio/CS_Wet Animation/URP/Flood/Opaque Packed Map"
{
	Properties
	{
		...
		[Space(35)]_DetailMAoHSMap("Packed Map  -->M(R) - Ao(G) - H(B) - S(A)", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 uv_DetailMAoHSMap = IN.ase_texcoord8.xyz.xy * _DetailMAoHSMap_ST.xy + _DetailMAoHSMap_ST.zw;
				float2 break26_g662 = uv_DetailMAoHSMap;
				...
				float4 tex2DNode3_g661 = tex2D( _DetailMAoHSMap, ( ( appendResult14_g662 + appendResult13_g662 ) + float2( 0,0 ) ) );
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 ase_tanViewDir =  tanToWorld0 * WorldViewDirection.x + tanToWorld1 * WorldViewDirection.y  + tanToWorld2 * WorldViewDirection.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float2 paralaxOffset38_g661 = ParallaxOffset( tex2DNode3_g661.b , _ParallaxDetail , ase_tanViewDir );
				float2 switchResult37_g661 = (((ase_vface>0)?(paralaxOffset38_g661):(0.0)));
				float2 Parallaxe494 = switchResult37_g661;
				float4 tex2DNode7_g641 = tex2D( _BaseMap, ( ( appendResult14_g642 + appendResult13_g642 ) + Parallaxe494 ) );
				float4 lerpResult53_g641 = lerp( _BaseColor , ( ( _BaseColor * tex2DNode7_g641 ) * _BaseColor.a ) , _BaseColor.a);
				float clampResult27_g641 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g641 = lerpResult53_g641.rgb;
				...
				float4 temp_output_551_0 = CalculateContrast(_Brightness,float4( desaturateVar29_g641 , 0.0 ));
				...
				float4 BaseColorRGB403 = temp_output_551_0;
				...
				float4 tex2DNode27_g612 = tex2D( _DetailMask, uv_DetailMask );
				#if defined(_CHANNELSELECTIONMASK_RED)
				float staticSwitch28_g612 = tex2DNode27_g612.r;
				#elif defined(_CHANNELSELECTIONMASK_GREEN)
				float staticSwitch28_g612 = tex2DNode27_g612.g;
				#elif defined(_CHANNELSELECTIONMASK_BLUE)
				float staticSwitch28_g612 = tex2DNode27_g612.b;
				#elif defined(_CHANNELSELECTIONMASK_ALPHA)
				float staticSwitch28_g612 = tex2DNode27_g612.a;
				#else
				float staticSwitch28_g612 = tex2DNode27_g612.r;
				#endif
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g641.a ) ):( tex2DNode7_g641.a ));
				float temp_output_43_0_g612 = BaseColorAlpha46;
				#if defined(_SOURCEMASK_DETAILMASK)
				float staticSwitch45_g612 = (( _InvertMask )?( ( 1.0 - staticSwitch28_g612 ) ):( staticSwitch28_g612 ));
				#elif defined(_SOURCEMASK_BASECOLORALPHA)
				float staticSwitch45_g612 = temp_output_43_0_g612;
				#elif defined(_SOURCEMASK_BOTH)
				float staticSwitch45_g612 = ( (( _InvertMask )?( ( 1.0 - staticSwitch28_g612 ) ):( staticSwitch28_g612 )) + temp_output_43_0_g612 );
				#else
				float staticSwitch45_g612 = (( _InvertMask )?( ( 1.0 - staticSwitch28_g612 ) ):( staticSwitch28_g612 ));
				#endif
				float4 temp_cast_6 = (( staticSwitch45_g612 + (-1.2 + (_SpreadDetailMap - 0.0) * (0.7 - -1.2) / (1.0 - 0.0)) )).xxxx;
				float4 temp_output_35_0_g612 = CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_6);
				float4 clampResult38_g612 = clamp( (( _ExcludeMask )?( ( temp_output_35_0_g612 * ( 1.0 - temp_output_43_0_g612 ) ) ):( temp_output_35_0_g612 )) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Mask158 = ( clampResult38_g612 * _IntensityMask );
				float4 lerpResult365 = lerp( temp_output_551_0 , AlbedoDetail153 , Mask158);
				...
				float2 break26_g644 = uv_BumpMap;
				float2 appendResult14_g644 = (float2(( break26_g644.x * GlobalTilingX11 ) , ( break26_g644.y * GlobalTilingY8 )));
				float2 appendResult13_g644 = (float2(( break26_g644.x + GlobalOffsetX10 ) , ( break26_g644.y + GlobalOffsetY9 )));
				float3 unpack4_g643 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g644 + appendResult13_g644 ) + Parallaxe494 ) ), _BumpScale );
				unpack4_g643.z = lerp( 1, unpack4_g643.z, saturate(_BumpScale) );
				float3 tex2DNode4_g643 = unpack4_g643;
				float3 temp_output_552_0 = tex2DNode4_g643;
				float2 temp_cast_8 = (_TranslationSpeed1).xx;
				float2 uv_DetailNormalMap = IN.ase_texcoord8.xyz.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				float cos54_g640 = cos( radians( _RotationAngle1 ) );
				float sin54_g640 = sin( radians( _RotationAngle1 ) );
				float2 rotator54_g640 = mul( ( uv_DetailNormalMap * _TilingWave1 ) - float2( 0.5,0.5 ) , float2x2( cos54_g640 , -sin54_g640 , sin54_g640 , cos54_g640 )) + float2( 0.5,0.5 );
				float2 panner86_g640 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_8 + rotator54_g640);
				float3 unpack107_g640 = UnpackNormalScale( tex2D( _DetailNormalMap, panner86_g640 ), _NormalWaveIntensity1 );
				unpack107_g640.z = lerp( 1, unpack107_g640.z, saturate(_NormalWaveIntensity1) );
				#ifdef _MAINWAVE_ON
				float3 staticSwitch109_g640 = unpack107_g640;
				#else
				float3 staticSwitch109_g640 = float3(0,0,1);
				#endif
				float2 temp_cast_9 = (_TranslationSpeed2).xx;
				float cos83_g640 = cos( radians( _RotationAngle2 ) );
				float sin83_g640 = sin( radians( _RotationAngle2 ) );
				float2 rotator83_g640 = mul( ( uv_DetailNormalMap * _TilingWave2 ) - float2( 0.5,0.5 ) , float2x2( cos83_g640 , -sin83_g640 , sin83_g640 , cos83_g640 )) + float2( 0.5,0.5 );
				float2 panner88_g640 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_9 + rotator83_g640);
				float3 unpack108_g640 = UnpackNormalScale( tex2D( _DetailNormalMap, panner88_g640 ), _NormalWaveIntensity2 );
				unpack108_g640.z = lerp( 1, unpack108_g640.z, saturate(_NormalWaveIntensity2) );
				#ifdef _DETAILWAVE_ON
				float3 staticSwitch56_g640 = BlendNormal( staticSwitch109_g640 , unpack108_g640 );
				#else
				float3 staticSwitch56_g640 = staticSwitch109_g640;
				#endif
				float3 NormalPuddles459 = staticSwitch56_g640;
				float3 lerpResult137 = lerp( temp_output_552_0 , NormalPuddles459 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_552_0 , BlendNormal( temp_output_552_0 , NormalPuddles459 ) , Mask158.rgb);
				...
				float2 break26_g651 = uv_EmissionMap;
				float2 appendResult14_g651 = (float2(( break26_g651.x * GlobalTilingX11 ) , ( break26_g651.y * GlobalTilingY8 )));
				float2 appendResult13_g651 = (float2(( break26_g651.x + GlobalOffsetX10 ) , ( break26_g651.y + GlobalOffsetY9 )));
				float4 temp_output_5_0_g650 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g651 + appendResult13_g651 ) + Parallaxe494 ) ) );
				float4 temp_output_554_0 = ( temp_output_5_0_g650 * _EmissionIntensity );
				float4 temp_cast_12 = (0.0).xxxx;
				float4 lerpResult394 = lerp( temp_output_554_0 , temp_cast_12 , Mask158);
				float3 worldRefl28_g649 = normalize( reflect( -WorldViewDirection, float3( dot( tanToWorld0, (( _UseMainNormalMapasNormalDirection )?( Normal27 ):( NormalPuddles459 )) ), dot( tanToWorld1, (( _UseMainNormalMapasNormalDirection )?( Normal27 ):( NormalPuddles459 )) ), dot( tanToWorld2, (( _UseMainNormalMapasNormalDirection )?( Normal27 ):( NormalPuddles459 )) ) ) ) );
				float4 texCUBENode27_g649 = texCUBElod( _Cubemap, float4( worldRefl28_g649, _BlurReflection) );
				float clampResult39_g649 = clamp( _ReflectionIntensity , 0.0 , 100.0 );
				float4 Emission110 = ( (( _UseEmissionFromMainProperties )?( temp_output_554_0 ):( lerpResult394 )) + ( ( texCUBENode27_g649 * ( texCUBENode27_g649.a * clampResult39_g649 ) * _ColorCubemap ) * Mask158 ) );
				
				float DetailMetallic381 = _Metallic2;
				float lerpResult382 = lerp( ( tex2DNode3_g661.r * _MetallicDetail ) , DetailMetallic381 , Mask158.r);
				float Metallic41 = lerpResult382;
				
				float temp_output_1_0_g661 = ( tex2DNode3_g661.a * _GlossinessDetail );
				float DetailSmoothness374 = _Glossiness2;
				float lerpResult377 = lerp( temp_output_1_0_g661 , DetailSmoothness374 , Mask158.r);
				float Smoothness40 = lerpResult377;
				
				float blendOpSrc34_g661 = tex2DNode3_g661.g;
				float blendOpDest34_g661 = ( 1.0 - _AoIntensityDetail );
				float temp_output_561_36 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc34_g661 ) * ( 1.0 - blendOpDest34_g661 ) ) ));
				float lerpResult389 = lerp( temp_output_561_36 , 1.0 , Mask158.r);
				float AmbientOcclusion94 = (( _UseAoFromMainProperties )?( temp_output_561_36 ):( lerpResult389 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float GlobalOffsetY9 = _GlobalXYTilingXYZWOffsetXY.w;
				float2 appendResult13_g642 = (float2(( break26_g642.x + GlobalOffsetX10 ) , ( break26_g642.y + GlobalOffsetY9 )));
				float2 uv_DetailMAoHSMap = IN.ase_texcoord4.xyz.xy * _DetailMAoHSMap_ST.xy + _DetailMAoHSMap_ST.zw;
				float2 break26_g662 = uv_DetailMAoHSMap;
				float2 appendResult14_g662 = (float2(( break26_g662.x * GlobalTilingX11 ) , ( break26_g662.y * GlobalTilingY8 )));
				float2 appendResult13_g662 = (float2(( break26_g662.x + GlobalOffsetX10 ) , ( break26_g662.y + GlobalOffsetY9 )));
				float4 tex2DNode3_g661 = tex2D( _DetailMAoHSMap, ( ( appendResult14_g662 + appendResult13_g662 ) + float2( 0,0 ) ) );
				...
				float4 lerpResult394 = lerp( temp_output_554_0 , temp_cast_8 , Mask158);
				float2 temp_cast_9 = (_TranslationSpeed1).xx;
				float2 uv_DetailNormalMap = IN.ase_texcoord4.xyz.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				float cos54_g640 = cos( radians( _RotationAngle1 ) );
				float sin54_g640 = sin( radians( _RotationAngle1 ) );
				float2 rotator54_g640 = mul( ( uv_DetailNormalMap * _TilingWave1 ) - float2( 0.5,0.5 ) , float2x2( cos54_g640 , -sin54_g640 , sin54_g640 , cos54_g640 )) + float2( 0.5,0.5 );
				float2 panner86_g640 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_9 + rotator54_g640);
				float3 unpack107_g640 = UnpackNormalScale( tex2D( _DetailNormalMap, panner86_g640 ), _NormalWaveIntensity1 );
				unpack107_g640.z = lerp( 1, unpack107_g640.z, saturate(_NormalWaveIntensity1) );
				#ifdef _MAINWAVE_ON
				float3 staticSwitch109_g640 = unpack107_g640;
				...
				float3 staticSwitch109_g640 = float3(0,0,1);
				#endif
				float2 temp_cast_10 = (_TranslationSpeed2).xx;
				float cos83_g640 = cos( radians( _RotationAngle2 ) );
				float sin83_g640 = sin( radians( _RotationAngle2 ) );
				float2 rotator83_g640 = mul( ( uv_DetailNormalMap * _TilingWave2 ) - float2( 0.5,0.5 ) , float2x2( cos83_g640 , -sin83_g640 , sin83_g640 , cos83_g640 )) + float2( 0.5,0.5 );
				float2 panner88_g640 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_10 + rotator83_g640);
				float3 unpack108_g640 = UnpackNormalScale( tex2D( _DetailNormalMap, panner88_g640 ), _NormalWaveIntensity2 );
				unpack108_g640.z = lerp( 1, unpack108_g640.z, saturate(_NormalWaveIntensity2) );
				#ifdef _DETAILWAVE_ON
				float3 staticSwitch56_g640 = BlendNormal( staticSwitch109_g640 , unpack108_g640 );
				...
				float3 lerpResult205 = lerp( temp_output_552_0 , BlendNormal( temp_output_552_0 , NormalPuddles459 ) , Mask158.rgb);
				float3 Normal27 = (( _BlendMainNormal )?( lerpResult205 ):( lerpResult137 ));
				float3 worldRefl28_g649 = normalize( reflect( -ase_worldViewDir, float3( dot( tanToWorld0, (( _UseMainNormalMapasNormalDirection )?( Normal27 ):( NormalPuddles459 )) ), dot( tanToWorld1, (( _UseMainNormalMapasNormalDirection )?( Normal27 ):( NormalPuddles459 )) ), dot( tanToWorld2, (( _UseMainNormalMapasNormalDirection )?( Normal27 ):( NormalPuddles459 )) ) ) ) );
				float4 texCUBENode27_g649 = texCUBElod( _Cubemap, float4( worldRefl28_g649, _BlurReflection) );
				float clampResult39_g649 = clamp( _ReflectionIntensity , 0.0 , 100.0 );
				float4 Emission110 = ( (( _UseEmissionFromMainProperties )?( temp_output_554_0 ):( lerpResult394 )) + ( ( texCUBENode27_g649 * ( texCUBENode27_g649.a * clampResult39_g649 ) * _ColorCubemap ) * Mask158 ) );
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float GlobalOffsetY9 = _GlobalXYTilingXYZWOffsetXY.w;
				float2 appendResult13_g644 = (float2(( break26_g644.x + GlobalOffsetX10 ) , ( break26_g644.y + GlobalOffsetY9 )));
				float2 uv_DetailMAoHSMap = IN.ase_texcoord5.xy * _DetailMAoHSMap_ST.xy + _DetailMAoHSMap_ST.zw;
				float2 break26_g662 = uv_DetailMAoHSMap;
				float2 appendResult14_g662 = (float2(( break26_g662.x * GlobalTilingX11 ) , ( break26_g662.y * GlobalTilingY8 )));
				float2 appendResult13_g662 = (float2(( break26_g662.x + GlobalOffsetX10 ) , ( break26_g662.y + GlobalOffsetY9 )));
				float4 tex2DNode3_g661 = tex2D( _DetailMAoHSMap, ( ( appendResult14_g662 + appendResult13_g662 ) + float2( 0,0 ) ) );
				...
				float sin54_g640 = sin( radians( _RotationAngle1 ) );
				float2 rotator54_g640 = mul( ( uv_DetailNormalMap * _TilingWave1 ) - float2( 0.5,0.5 ) , float2x2( cos54_g640 , -sin54_g640 , sin54_g640 , cos54_g640 )) + float2( 0.5,0.5 );
				float2 panner86_g640 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_0 + rotator54_g640);
				float3 unpack107_g640 = UnpackNormalScale( tex2D( _DetailNormalMap, panner86_g640 ), _NormalWaveIntensity1 );
				unpack107_g640.z = lerp( 1, unpack107_g640.z, saturate(_NormalWaveIntensity1) );
				#ifdef _MAINWAVE_ON
				float3 staticSwitch109_g640 = unpack107_g640;
				...
				float sin83_g640 = sin( radians( _RotationAngle2 ) );
				float2 rotator83_g640 = mul( ( uv_DetailNormalMap * _TilingWave2 ) - float2( 0.5,0.5 ) , float2x2( cos83_g640 , -sin83_g640 , sin83_g640 , cos83_g640 )) + float2( 0.5,0.5 );
				float2 panner88_g640 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_1 + rotator83_g640);
				float3 unpack108_g640 = UnpackNormalScale( tex2D( _DetailNormalMap, panner88_g640 ), _NormalWaveIntensity2 );
				unpack108_g640.z = lerp( 1, unpack108_g640.z, saturate(_NormalWaveIntensity2) );
				#ifdef _DETAILWAVE_ON
				float3 staticSwitch56_g640 = BlendNormal( staticSwitch109_g640 , unpack108_g640 );
				...
				float staticSwitch45_g612 = (( _InvertMask )?( ( 1.0 - staticSwitch28_g612 ) ):( staticSwitch28_g612 ));
				#endif
				float4 temp_cast_2 = (( staticSwitch45_g612 + (-1.2 + (_SpreadDetailMap - 0.0) * (0.7 - -1.2) / (1.0 - 0.0)) )).xxxx;
				float4 temp_output_35_0_g612 = CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_2);
				float4 clampResult38_g612 = clamp( (( _ExcludeMask )?( ( temp_output_35_0_g612 * ( 1.0 - temp_output_43_0_g612 ) ) ):( temp_output_35_0_g612 )) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Mask158 = ( clampResult38_g612 * _IntensityMask );
				float3 lerpResult137 = lerp( temp_output_552_0 , NormalPuddles459 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_552_0 , BlendNormal( temp_output_552_0 , NormalPuddles459 ) , Mask158.rgb);
