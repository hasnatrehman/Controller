	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float staticSwitch45_g612 = (( _InvertMask )?( ( 1.0 - staticSwitch28_g612 ) ):( staticSwitch28_g612 ));
				#endif
				float4 temp_cast_8 = (( staticSwitch45_g612 + (-1.2 + (_SpreadDetailMap - 0.0) * (0.7 - -1.2) / (1.0 - 0.0)) )).xxxx;
				float4 temp_output_35_0_g612 = CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_8);
				...
				float2 panner86_g640 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_10 + rotator54_g640);
				...
				float2 panner88_g640 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_11 + rotator83_g640);
				...
				float2 break26_g648 = uv_EmissionMap;
				float2 appendResult14_g648 = (float2(( break26_g648.x * GlobalTilingX11 ) , ( break26_g648.y * GlobalTilingY8 )));
				float2 appendResult13_g648 = (float2(( break26_g648.x + GlobalOffsetX10 ) , ( break26_g648.y + GlobalOffsetY9 )));
				float4 temp_output_5_0_g647 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g648 + appendResult13_g648 ) + Parallaxe494 ) ) );
				float4 temp_output_554_0 = ( temp_output_5_0_g647 * _EmissionIntensity );
				float4 temp_cast_14 = (0.0).xxxx;
				float4 lerpResult394 = lerp( temp_output_554_0 , temp_cast_14 , Mask158);
				...
				float2 break26_g646 = uv_OcclusionMap;
				float2 appendResult14_g646 = (float2(( break26_g646.x * GlobalTilingX11 ) , ( break26_g646.y * GlobalTilingY8 )));
				float2 appendResult13_g646 = (float2(( break26_g646.x + GlobalOffsetX10 ) , ( break26_g646.y + GlobalOffsetY9 )));
				float blendOpSrc2_g645 = tex2D( _OcclusionMap, ( ( appendResult14_g646 + appendResult13_g646 ) + Parallaxe494 ) ).r;
				float blendOpDest2_g645 = ( 1.0 - _OcclusionStrength );
				float temp_output_553_0 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc2_g645 ) * ( 1.0 - blendOpDest2_g645 ) ) ));
				float lerpResult389 = lerp( temp_output_553_0 , 1.0 , Mask158.r);
				float AmbientOcclusion94 = (( _UseAoFromMainProperties )?( temp_output_553_0 ):( lerpResult389 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float4 lerpResult394 = lerp( temp_output_554_0 , temp_cast_10 , Mask158);
				...
				float sin54_g640 = sin( radians( _RotationAngle1 ) );
				float2 rotator54_g640 = mul( ( uv_DetailNormalMap * _TilingWave1 ) - float2( 0.5,0.5 ) , float2x2( cos54_g640 , -sin54_g640 , sin54_g640 , cos54_g640 )) + float2( 0.5,0.5 );
				float2 panner86_g640 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_11 + rotator54_g640);
				float3 unpack107_g640 = UnpackNormalScale( tex2D( _DetailNormalMap, panner86_g640 ), _NormalWaveIntensity1 );
				unpack107_g640.z = lerp( 1, unpack107_g640.z, saturate(_NormalWaveIntensity1) );
				#ifdef _MAINWAVE_ON
				float3 staticSwitch109_g640 = unpack107_g640;
				...
				float sin83_g640 = sin( radians( _RotationAngle2 ) );
				float2 rotator83_g640 = mul( ( uv_DetailNormalMap * _TilingWave2 ) - float2( 0.5,0.5 ) , float2x2( cos83_g640 , -sin83_g640 , sin83_g640 , cos83_g640 )) + float2( 0.5,0.5 );
				float2 panner88_g640 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_12 + rotator83_g640);
				float3 unpack108_g640 = UnpackNormalScale( tex2D( _DetailNormalMap, panner88_g640 ), _NormalWaveIntensity2 );
				unpack108_g640.z = lerp( 1, unpack108_g640.z, saturate(_NormalWaveIntensity2) );
				#ifdef _DETAILWAVE_ON
				float3 staticSwitch56_g640 = BlendNormal( staticSwitch109_g640 , unpack108_g640 );
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float sin54_g640 = sin( radians( _RotationAngle1 ) );
				float2 rotator54_g640 = mul( ( uv_DetailNormalMap * _TilingWave1 ) - float2( 0.5,0.5 ) , float2x2( cos54_g640 , -sin54_g640 , sin54_g640 , cos54_g640 )) + float2( 0.5,0.5 );
				float2 panner86_g640 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_2 + rotator54_g640);
				float3 unpack107_g640 = UnpackNormalScale( tex2D( _DetailNormalMap, panner86_g640 ), _NormalWaveIntensity1 );
				unpack107_g640.z = lerp( 1, unpack107_g640.z, saturate(_NormalWaveIntensity1) );
				#ifdef _MAINWAVE_ON
				float3 staticSwitch109_g640 = unpack107_g640;
				...
				float sin83_g640 = sin( radians( _RotationAngle2 ) );
				float2 rotator83_g640 = mul( ( uv_DetailNormalMap * _TilingWave2 ) - float2( 0.5,0.5 ) , float2x2( cos83_g640 , -sin83_g640 , sin83_g640 , cos83_g640 )) + float2( 0.5,0.5 );
				float2 panner88_g640 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_3 + rotator83_g640);
				float3 unpack108_g640 = UnpackNormalScale( tex2D( _DetailNormalMap, panner88_g640 ), _NormalWaveIntensity2 );
				unpack108_g640.z = lerp( 1, unpack108_g640.z, saturate(_NormalWaveIntensity2) );
				#ifdef _DETAILWAVE_ON
				float3 staticSwitch56_g640 = BlendNormal( staticSwitch109_g640 , unpack108_g640 );
				...
				float staticSwitch45_g612 = (( _InvertMask )?( ( 1.0 - staticSwitch28_g612 ) ):( staticSwitch28_g612 ));
				#endif
				float4 temp_cast_4 = (( staticSwitch45_g612 + (-1.2 + (_SpreadDetailMap - 0.0) * (0.7 - -1.2) / (1.0 - 0.0)) )).xxxx;
				float4 temp_output_35_0_g612 = CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_4);
				float4 clampResult38_g612 = clamp( (( _ExcludeMask )?( ( temp_output_35_0_g612 * ( 1.0 - temp_output_43_0_g612 ) ) ):( temp_output_35_0_g612 )) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Mask158 = ( clampResult38_g612 * _IntensityMask );
				float3 lerpResult137 = lerp( temp_output_552_0 , NormalPuddles459 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_552_0 , BlendNormal( temp_output_552_0 , NormalPuddles459 ) , Mask158.rgb);
