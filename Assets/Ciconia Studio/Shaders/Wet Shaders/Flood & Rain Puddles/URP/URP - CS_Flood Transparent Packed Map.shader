Shader "Ciconia Studio/CS_Wet Animation/URP/Flood/Transparent Packed Map"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 Parallaxe519 = switchResult37_g661;
				float4 tex2DNode7_g641 = tex2D( _BaseMap, ( ( appendResult14_g642 + appendResult13_g642 ) + Parallaxe519 ) );
				...
				float4 temp_output_556_0 = CalculateContrast(_Brightness,float4( desaturateVar29_g641 , 0.0 ));
				...
				float4 BaseColorRGB403 = temp_output_556_0;
				...
				float staticSwitch45_g608 = (( _InvertMask )?( ( 1.0 - staticSwitch28_g608 ) ):( staticSwitch28_g608 ));
				#endif
				float4 temp_cast_6 = (( staticSwitch45_g608 + (-1.2 + (_SpreadDetailMap - 0.0) * (0.7 - -1.2) / (1.0 - 0.0)) )).xxxx;
				float4 temp_output_35_0_g608 = CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_6);
				...
				float4 lerpResult365 = lerp( temp_output_556_0 , AlbedoDetail153 , Mask158);
				...
				float3 unpack4_g643 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g644 + appendResult13_g644 ) + Parallaxe519 ) ), _BumpScale );
				unpack4_g643.z = lerp( 1, unpack4_g643.z, saturate(_BumpScale) );
				float3 tex2DNode4_g643 = unpack4_g643;
				float3 temp_output_557_0 = tex2DNode4_g643;
				...
				float cos54_g639 = cos( radians( _RotationAngle1 ) );
				float sin54_g639 = sin( radians( _RotationAngle1 ) );
				float2 rotator54_g639 = mul( ( uv_DetailNormalMap * _TilingWave1 ) - float2( 0.5,0.5 ) , float2x2( cos54_g639 , -sin54_g639 , sin54_g639 , cos54_g639 )) + float2( 0.5,0.5 );
				float2 panner86_g639 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_8 + rotator54_g639);
				float3 unpack107_g639 = UnpackNormalScale( tex2D( _DetailNormalMap, panner86_g639 ), _NormalWaveIntensity1 );
				unpack107_g639.z = lerp( 1, unpack107_g639.z, saturate(_NormalWaveIntensity1) );
				#ifdef _MAINWAVE_ON
				float3 staticSwitch109_g639 = unpack107_g639;
				#else
				float3 staticSwitch109_g639 = float3(0,0,1);
				#endif
				float2 temp_cast_9 = (_TranslationSpeed2).xx;
				float cos83_g639 = cos( radians( _RotationAngle2 ) );
				float sin83_g639 = sin( radians( _RotationAngle2 ) );
				float2 rotator83_g639 = mul( ( uv_DetailNormalMap * _TilingWave2 ) - float2( 0.5,0.5 ) , float2x2( cos83_g639 , -sin83_g639 , sin83_g639 , cos83_g639 )) + float2( 0.5,0.5 );
				float2 panner88_g639 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_9 + rotator83_g639);
				float3 unpack108_g639 = UnpackNormalScale( tex2D( _DetailNormalMap, panner88_g639 ), _NormalWaveIntensity2 );
				unpack108_g639.z = lerp( 1, unpack108_g639.z, saturate(_NormalWaveIntensity2) );
				#ifdef _DETAILWAVE_ON
				float3 staticSwitch56_g639 = BlendNormal( staticSwitch109_g639 , unpack108_g639 );
				#else
				float3 staticSwitch56_g639 = staticSwitch109_g639;
				#endif
				float3 NormalPuddles459 = staticSwitch56_g639;
				float3 lerpResult137 = lerp( temp_output_557_0 , NormalPuddles459 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_557_0 , BlendNormal( temp_output_557_0 , NormalPuddles459 ) , Mask158.rgb);
				...
				float4 temp_output_5_0_g650 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g651 + appendResult13_g651 ) + Parallaxe519 ) ) );
				float4 temp_output_559_0 = ( temp_output_5_0_g650 * _EmissionIntensity );
				float4 temp_cast_12 = (0.0).xxxx;
				float4 lerpResult394 = lerp( temp_output_559_0 , temp_cast_12 , Mask158);
				float3 worldRefl28_g652 = normalize( reflect( -WorldViewDirection, float3( dot( tanToWorld0, (( _UseMainNormalMapasNormalDirection1 )?( Normal27 ):( NormalPuddles459 )) ), dot( tanToWorld1, (( _UseMainNormalMapasNormalDirection1 )?( Normal27 ):( NormalPuddles459 )) ), dot( tanToWorld2, (( _UseMainNormalMapasNormalDirection1 )?( Normal27 ):( NormalPuddles459 )) ) ) ) );
				float4 texCUBENode27_g652 = texCUBElod( _Cubemap, float4( worldRefl28_g652, _BlurReflection) );
				float clampResult39_g652 = clamp( _ReflectionIntensity , 0.0 , 100.0 );
				...
				float4 staticSwitch511 = temp_cast_19;
				#elif defined(_MASKSELECTION_DETAILMASK)
				float4 staticSwitch511 = Mask158;
				#elif defined(_MASKSELECTION_BASECOLORALPHA)
				float4 staticSwitch511 = temp_cast_20;
				#else
				float4 staticSwitch511 = Mask158;
				#endif
				float4 GrabSreenRefraction503 = ( ( fetchOpaqueVal502 * (( _InvertTransparencyMask )?( ( 1.0 - staticSwitch511 ) ):( staticSwitch511 )) ) * _Opacity );
				float4 Emission110 = ( (( _UseEmissionFromMainProperties )?( temp_output_559_0 ):( lerpResult394 )) + ( ( texCUBENode27_g652 * ( texCUBENode27_g652.a * clampResult39_g652 ) * _ColorCubemap ) * Mask158 ) + GrabSreenRefraction503 );
				...
				float temp_output_562_36 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc34_g661 ) * ( 1.0 - blendOpDest34_g661 ) ) ));
				float lerpResult389 = lerp( temp_output_562_36 , 1.0 , Mask158.r);
				float AmbientOcclusion94 = (( _UseAoFromMainProperties )?( temp_output_562_36 ):( lerpResult389 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float4 lerpResult394 = lerp( temp_output_559_0 , temp_cast_8 , Mask158);
				...
				float sin54_g639 = sin( radians( _RotationAngle1 ) );
				float2 rotator54_g639 = mul( ( uv_DetailNormalMap * _TilingWave1 ) - float2( 0.5,0.5 ) , float2x2( cos54_g639 , -sin54_g639 , sin54_g639 , cos54_g639 )) + float2( 0.5,0.5 );
				float2 panner86_g639 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_9 + rotator54_g639);
				float3 unpack107_g639 = UnpackNormalScale( tex2D( _DetailNormalMap, panner86_g639 ), _NormalWaveIntensity1 );
				unpack107_g639.z = lerp( 1, unpack107_g639.z, saturate(_NormalWaveIntensity1) );
				#ifdef _MAINWAVE_ON
				float3 staticSwitch109_g639 = unpack107_g639;
				...
				float sin83_g639 = sin( radians( _RotationAngle2 ) );
				float2 rotator83_g639 = mul( ( uv_DetailNormalMap * _TilingWave2 ) - float2( 0.5,0.5 ) , float2x2( cos83_g639 , -sin83_g639 , sin83_g639 , cos83_g639 )) + float2( 0.5,0.5 );
				float2 panner88_g639 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_10 + rotator83_g639);
				float3 unpack108_g639 = UnpackNormalScale( tex2D( _DetailNormalMap, panner88_g639 ), _NormalWaveIntensity2 );
				unpack108_g639.z = lerp( 1, unpack108_g639.z, saturate(_NormalWaveIntensity2) );
				#ifdef _DETAILWAVE_ON
				float3 staticSwitch56_g639 = BlendNormal( staticSwitch109_g639 , unpack108_g639 );
				...
				float3 lerpResult205 = lerp( temp_output_557_0 , BlendNormal( temp_output_557_0 , NormalPuddles459 ) , Mask158.rgb);
				float3 Normal27 = (( _BlendMainNormal )?( lerpResult205 ):( lerpResult137 ));
				float3 worldRefl28_g652 = normalize( reflect( -ase_worldViewDir, float3( dot( tanToWorld0, (( _UseMainNormalMapasNormalDirection1 )?( Normal27 ):( NormalPuddles459 )) ), dot( tanToWorld1, (( _UseMainNormalMapasNormalDirection1 )?( Normal27 ):( NormalPuddles459 )) ), dot( tanToWorld2, (( _UseMainNormalMapasNormalDirection1 )?( Normal27 ):( NormalPuddles459 )) ) ) ) );
				float4 texCUBENode27_g652 = texCUBElod( _Cubemap, float4( worldRefl28_g652, _BlurReflection) );
				float clampResult39_g652 = clamp( _ReflectionIntensity , 0.0 , 100.0 );
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float sin54_g639 = sin( radians( _RotationAngle1 ) );
				float2 rotator54_g639 = mul( ( uv_DetailNormalMap * _TilingWave1 ) - float2( 0.5,0.5 ) , float2x2( cos54_g639 , -sin54_g639 , sin54_g639 , cos54_g639 )) + float2( 0.5,0.5 );
				float2 panner86_g639 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_0 + rotator54_g639);
				float3 unpack107_g639 = UnpackNormalScale( tex2D( _DetailNormalMap, panner86_g639 ), _NormalWaveIntensity1 );
				unpack107_g639.z = lerp( 1, unpack107_g639.z, saturate(_NormalWaveIntensity1) );
				#ifdef _MAINWAVE_ON
				float3 staticSwitch109_g639 = unpack107_g639;
				...
				float sin83_g639 = sin( radians( _RotationAngle2 ) );
				float2 rotator83_g639 = mul( ( uv_DetailNormalMap * _TilingWave2 ) - float2( 0.5,0.5 ) , float2x2( cos83_g639 , -sin83_g639 , sin83_g639 , cos83_g639 )) + float2( 0.5,0.5 );
				float2 panner88_g639 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_1 + rotator83_g639);
				float3 unpack108_g639 = UnpackNormalScale( tex2D( _DetailNormalMap, panner88_g639 ), _NormalWaveIntensity2 );
				unpack108_g639.z = lerp( 1, unpack108_g639.z, saturate(_NormalWaveIntensity2) );
				#ifdef _DETAILWAVE_ON
				float3 staticSwitch56_g639 = BlendNormal( staticSwitch109_g639 , unpack108_g639 );
				...
				float staticSwitch45_g608 = (( _InvertMask )?( ( 1.0 - staticSwitch28_g608 ) ):( staticSwitch28_g608 ));
				#endif
				float4 temp_cast_2 = (( staticSwitch45_g608 + (-1.2 + (_SpreadDetailMap - 0.0) * (0.7 - -1.2) / (1.0 - 0.0)) )).xxxx;
				float4 temp_output_35_0_g608 = CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_2);
				float4 clampResult38_g608 = clamp( (( _ExcludeMask )?( ( temp_output_35_0_g608 * ( 1.0 - temp_output_43_0_g608 ) ) ):( temp_output_35_0_g608 )) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Mask158 = ( clampResult38_g608 * _IntensityMask );
				float3 lerpResult137 = lerp( temp_output_557_0 , NormalPuddles459 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_557_0 , BlendNormal( temp_output_557_0 , NormalPuddles459 ) , Mask158.rgb);
